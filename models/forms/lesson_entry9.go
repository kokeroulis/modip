...
CREATE TABLE LessonCreateReportFormEntry9 (
	...
	lesson_aksiologisi_ths_epidosis_grapti_eksetasi boolean,
	lesson_aksiologisi_ths_epidosis_proforiki_eksetasi boolean,
	lesson_aksiologisi_ths_epidosis_proodos boolean,
	lesson_aksiologisi_ths_epidosis_katoi_kon_ergasia boolean,
	lesson_aksiologisi_ths_epidosis_proforiki_parousiasi_ergasias boolean,
	lesson_aksiologisi_ths_epidosis_ergashtirio_praktikes_askiseis boolean,
	lesson_aksiologisi_ths_epidosis_alla boolean,
	lesson_aksiologisi_ths_epidosis_epeksigiseis_alla text,
	lesson_aksiologisi_ths_epidosis_parakolou8ish_spoudaston_sto_erg boolean,
	lesson_aksiologisi_ths_epidosis_sxolia_mesa_eksaminou boolean,
	lesson_aksiologisi_ths_epidosis_diafania_aksiologisis_tis_epidosis text
)
=============== End Create table
