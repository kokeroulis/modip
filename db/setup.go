...
func CreateDb() {
	schemaList := []string{
		...
		DbSchema.LessonCreateReportFormEntry6,
		DbSchema.LessonCreateReportFormEntry7,
		DbSchema.LessonCreateReportFormEntry8,
		DbSchema.LessonCreateReportFormEntry9,
		DbSchema.LessonCreateReportFormEntry10,
